...
* **releases/stable:** This branch is orphaned and contains only the package contents for the library. This is updated in sync with tagged releases on **master** and each commit that changes these contents should result in the version in **package.json** being changed.
